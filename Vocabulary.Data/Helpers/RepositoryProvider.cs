...
namespace Vocabulary.Data.Helpers
{
    /// <summary>
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        public RepositoryProvider(RepositoryFactories repositoryFactories, VocabularyDbContext context)
        {
        ...
        {
            Func<DbContext, object> f = factory ?? repositoryFactories.GetRepositoryFactory<T>();
            if (f == null)
            {
